defmodule WineCellar do
  ...
  def filter(cellar, color, opts \\ []) do
    # IO.inspect(opts)
    # IO.inspect(Keyword.get_values(opts, :year))
    # IO.inspect(Keyword.get_values(opts, :country))
    # year = Keyword.get(opts, :year, nil)
    # country= Keyword.get(opts, :country, nil)
    year = opts |> Keyword.get_values(:year) |> List.first()
    country = opts |> Keyword.get_values(:country) |> List.first()
