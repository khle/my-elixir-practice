defmodule Username do
  def match_and_replace([], _pattern, _replaced_with), do: []
  def match_and_replace([pattern | tail], pattern, replaced_with) do
    replaced_with ++ match_and_replace(tail, pattern, replaced_with)
  end
  def match_and_replace([head | tail], pattern, replaced_with) do
